...
function applyTheme(preference) {
    const normalizedPreference = ['system', 'dark', 'light'].includes(preference)
        ? preference
        : 'system';
    ...
    document.querySelectorAll('.theme-toggle').forEach(toggle => {
        ...
        if (icon) {
            icon.classList.toggle('bx-sun', resolvedTheme === 'dark');
            icon.classList.toggle('bx-moon', resolvedTheme === 'light');
        }
    });
}
